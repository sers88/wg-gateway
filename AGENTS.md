...
Single Docker image that bundles **wg-easy v15.3.0** (WireGuard management), **Mihomo v1.19.27** (proxy/routing engine), and **metacubexd v1.258.1** (Mihomo UI). No application code — the repo is shell scripts, configs, and a Dockerfile that assembles third-party components.
